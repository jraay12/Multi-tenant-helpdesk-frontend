          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="px-7 pt-6 pb-7">
              ...
              <div className="flex items-center justify-between pt-5 border-t border-gray-100">
                ...
                <button
                  type="submit"
                  className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 active:scale-[.98] text-white text-sm font-medium px-5 py-2.5 rounded-lg transition-all"
                >
                  Continue
                  <svg
